...
namespace MVCdemo.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MVCdemoContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCdemoContext = _context.Product.Include(p => p.Vendor);
        ...
        public async Task<IActionResult> Create([Bind("ProductID,Description,QtyonHand,ReorderPoint,Status,Cost,Price,VendorID")] Product product)
        {
